...
<template>
  <div>
    <!-- <div class="tools-bar" style="display: flex;align-items: center;width: 70%;">
        <div class="tool" style="display: flex; gap: 30px;padding: 5px;flex: 3;align-items: center;width: 70%;">
            <div class="search-bar" style="height: 100%; flex: 3;">
                <input type="text" style="height: 30px;border-radius: 4px; border: 1px solid green; width: 100%;" placeholder="">
            </div>
            <div class="filter" style="flex: 1;">
                <svgicon :svg="svg.svgfilter"/>
            </div>
        </div>
      ...
      <div class="post" style="" v-for="item in Posts" :key="item.id">
        <div class="post-header">
          ...
          <div class="post-title">
            ...
            <span v-else>{{ item.title.slice(0, 35) }}...</span>
          </div>
        ...
        <div class="post-details">
          <div>
            <div class="detail-properties">status</div>
          ...
          <div>
            <div class="detail-properties">Leads</div>
            <div class="details-values">
              {{ item.visits }}
            </div>
          </div>
          <div>
            <div class="detail-properties">Launch date</div>
            <div class="details-values">
              {{ item.launch_date }}
            </div>
          </div>
          <div>
            <div class="detail-properties">Progress</div>
            <div class="details-values">
